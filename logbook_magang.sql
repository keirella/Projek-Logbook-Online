...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 23, 2026 at 04:16 AM
...
CREATE TABLE `logbooks` (
  ...
  `status_magang` int(11) DEFAULT 0,
  `status_ruangan` int(11) DEFAULT 0
...
INSERT INTO `logbooks` (`id`, `user_id`, `hari_tanggal`, `nama_pendamping_magang`, `nama_pendamping_ruangan`, `tempat_ruangan`, `uraian_kegiatan`, `status_magang`, `status_ruangan`) VALUES
...
INSERT INTO `users` (`id`, `nama`, `nim_nip`, `nim_hash`, `asal`, `password`) VALUES
(2, '1932l+oSKDRfrBNQYsErXg==', 'nZC+Q6lyN0jSVj+QPv/m4g==', '64e536294e75c0413d9702f93bbf622226a050e59e39ffe5671022e8a346ac55', 'UPN \"Veteran\" Yogyakarta', '$2y$10$KqrqLpzLwhFLBuffwHF9X.x1g/bT6BUtE74AX1RMmARi4.sXGFjCO');
